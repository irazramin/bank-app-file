...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if ($customer->showBalance() < $amount) {
    $errors["error"] = "Insufficient balance";
  }
  if ($amount <= 0) {
    $errors["error"] = "Incorrect amount";
  }

  if (empty($errors)) {
    $customer->transferAmount($amount, $email);
      ...
      <nav class="border-b border-emerald-300 border-opacity-25 bg-emerald-600"
            ...
            <div class="flex items-center px-2 lg:px-0">
              <div class="hidden sm:block">
                <div class="flex space-x-4">
                  ...
                  <a href="transfer.php"
                    class="bg-emerald-700 text-white rounded-md py-2 px-3 text-sm font-medium">Transfer</a>
                </div>
              </div>
            </div>
        ...
        <div x-show="mobileMenuOpen" class="sm:hidden" id="mobile-menu">
          <div class="space-y-1 pt-2 pb-3">
            ...
            <a href="transfer.php"
              class="bg-emerald-700 text-white block rounded-md py-2 px-3 text-base font-medium">Transfer</a>
          </div>
        ...
        <div class="bg-white rounded-lg p-2">
          <?php if (isset($errors["error"])): ?>
            <div class="flex items-center p-4 mb-4 text-sm text-red-800 border border-red-300 rounded-lg bg-red-50"
              ...
              <div>
                <span class="font-medium"> <?= $errors["error"]; ?> </span>
              </div>
            </div>
          <?php endif; ?>
