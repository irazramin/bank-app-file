...
if ($_SERVER["REQUEST_METHOD"] == 'POST') {
  ...
  if ($amount <= $_SESSION["user"]["balance"]) {
      ...
      <nav class="border-b border-emerald-300 border-opacity-25 bg-emerald-600"
            ...
            <div class="flex items-center px-2 lg:px-0">
              <div class="hidden sm:block">
                <div class="flex space-x-4">
                  ...
                  <a href="withdraw.php"
                    class="bg-emerald-700 text-white rounded-md py-2 px-3 text-sm font-medium">Withdraw</a>
                  <a href="transfer.php"
        ...
        <div x-show="mobileMenuOpen" class="sm:hidden" id="mobile-menu">
          <div class="space-y-1 pt-2 pb-3">
            ...
            <a href="withdraw.php"
              class="bg-emerald-700 text-white block rounded-md py-2 px-3 text-base font-medium">Withdraw</a>
