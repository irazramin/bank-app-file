            ...
            <div class="flow-root mt-8">
              <div class="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                <ul role="list" class="divide-y divide-gray-100">
                  ...
                  <?php foreach ($customer->getAllCustomers() as $usr): ?>
                      ...
                      <div class="flex gap-x-4">
                        ...
                        <span class="inline-flex items-center justify-center w-12 h-12 rounded-full bg-sky-500">
                          <span class="text-xl font-medium leading-none text-white">
                            <span class="font-medium leading-none text-white"><?= name_extract($usr["name"]) ?></span>
                          </span>
                        </span>

                        <div class="flex-auto min-w-0">
                          <p class="text-sm font-semibold leading-6 text-gray-900">
                            <a href='customer_transactions.php?email=<?php echo urlencode($usr['email']); ?>'>
                              <span class="absolute inset-x-0 bottom-0 -top-px"></span>
                              <?= $usr["name"] ?>
                            </a>
                          </p>
                          <p class="flex mt-1 text-xs leading-5 text-gray-500">
                            <a href="customer_transactions.php" class="relative truncate hover:underline">
                              <?= $usr["email"] ?></a>
                          </p>
                        </div>
                      </div>
